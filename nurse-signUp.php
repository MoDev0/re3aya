...
<?php
        ...
        $select="SELECT * FROM`users`WHERE `mail`='$mail'";
            ...
            if(count($error)==0){
        $sql="INSERT INTO `users` (`name`,`mobile`,`mail`,`birth`,`gender`,`city`,`area`,`image`,`pass`,`type`) VALUES('$name','$phone','$mail','$date','$gender','$city','$area','".$fileName."','$pass','Nurse')";
        ...
        <div class="manage-profile-data">
            ...
            <form class="edit-data-form" method="POST" enctype="multipart/form-data">
                ...
                <div class="field-container">
                    ...
                    <input class="upload--img" type="file" name="photo" accept="image/*" id="profile">
                </div>
