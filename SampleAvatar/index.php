...
<head>
    ...
    */
	...
	if ( !isset( $_SESSION['userToken']) || !isset( $_SESSION['tokenExpireTime']) || time() >= $_SESSION['tokenExpireTime'] )
	{
		...
		$tokenGenerator = new TokenGenerator("Yq7k4_GMAIL_COM_AUT","Nw54GbPi9n8JHy26T","https://authservice.priaid.ch/login");
...
<body>
    ...
    <table class="container-table">
        ...
        <tr>
            ...
            <td valign="top" class="selector_container bordered-box box-white width25"><div id="diagnosisList"><button onclick="window.location.href='../doctor.php'">Book a doctor</button></div></td>
        </tr>
    </table>
